...
{
    public class AppSeedingData
    {
        public static void SeedData(IApplicationBuilder applicationBuilder)
        {
            using (var scopeBuilder = applicationBuilder.ApplicationServices.CreateScope())
            {
                var dbContext = scopeBuilder.ServiceProvider.GetService<AppDbContext>();
                ...
                {
                    dbContext.ActorMovies.AddRange(new List<ActorMovie>()
                    {
                        new ActorMovie()
                        {
                            ActorId = 1,
